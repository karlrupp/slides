...
\hypersetup{pdftitle = {PETSc Tutorial - About, Installation, Vectors and Matrices, Linear Solvers, Preconditioners, Distributed Arrays},
            pdfsubject = {PETSc User Meeting 2016},
            pdfauthor={Karl Rupp (based on slides of Jed Brown et al.)}}
...
\title[PETSc]{ { { \Huge PETSc Tutorial } \\ About, Installation, Vectors and Matrices, \\
                                             Linear Solvers, Preconditioners, Distributed Arrays } %\\[0.5em] Portable, Extensible Toolkit for Scientific Computation
             }
