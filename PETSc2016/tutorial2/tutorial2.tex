...
\hypersetup{pdftitle = {PETSc Tutorial - Profiling, Nonlinear Solvers, Unstructured Grids, Threads and GPUs},
...
\title[PETSc]{ { { \Huge PETSc Tutorial } \\ Profiling, Nonlinear Solvers, \\
                                             Unstructured Grids, Threads and GPUs } %\\[0.5em] Portable, Extensible Toolkit for Scientific Computation
             }
